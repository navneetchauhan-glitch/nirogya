                  ...
                  {filteredDocuments.map((doc) => (
                    ...
                    >
                      <div className="p-6">
                        ...
                        <div className="flex gap-2">
                          <button className="flex-1 px-3 py-2 bg-[#e8e8e0] hover:bg-[#d4d4c8] text-[#1a1a1a] rounded-xl transition-colors text-sm font-medium flex items-center justify-center gap-2">
